...
import { getCounterwiseTotalCollectionAmtDetailsApi, getRouteWiseAssignedVehicleCountDetailsApi } from '../../../Services/ReportService';
...
const Dashboard = () => {
  ...
  const routeCount = (sendData) => {
    getRouteWiseAssignedVehicleCountDetailsApi(sendData, (res) => {
      if (res?.RoutewiseAssignedVehicle !== undefined && res?.RoutewiseAssignedVehicle.length > 0) {
